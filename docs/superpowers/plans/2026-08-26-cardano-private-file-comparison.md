...
- [x] **Step 3: Install only the three approved direct dependencies**
...
- [x] **Step 4: Implement the minimal frozen protocol**
...
- [x] **Step 1: Write failing tests with generated minimal fixtures**
...
- [x] **Step 3: Implement type detection and text parsing**
...
- [x] **Step 4: Implement lazy DOCX preflight before Mammoth**
...
- [x] **Step 5: Implement private PDF inspection**
...
- [x] **Step 1: Write failing server and client boundary tests**
...
- [x] **Step 3: Implement the native Node HTTP server**
...
- [x] **Step 4: Implement the internal client**
...
- [x] **Step 5: Run GREEN and compiled import check**
...
- [x] **Step 3: Implement deterministic lexical selection**
...
- [x] **Step 4: Implement strict comparison generation and verification**
...
- [x] **Step 5: Render localized private/public provenance**
...
- [x] **Step 6: Run GREEN and public grounding regressions**
...
- [x] **Step 1: Write failing webhook and queue tests**
...
- [x] **Step 3: Implement exact Telegram document parsing**
...
- [x] **Step 4: Implement encrypted queue admission**
...
- [x] **Step 5: Run GREEN and security regressions**
...
- [x] **Step 1: Write failing Telegram adapter/download tests**
...
- [x] **Step 3: Extend the Telegram API interface narrowly**
...
- [x] **Step 4: Implement bounded download and cleanup**
...
- [x] **Step 3: Add fail-closed private runtime configuration**
...
- [x] **Step 4: Register the private queue worker**
...
- [x] **Step 5: Run GREEN and broad worker regressions**
...
- [x] **Step 3: Reuse the shared ingress parser/admission boundary**
...
- [x] **Step 1: Write failing Compose/config tests**
...
- [x] **Step 3: Add the private extractor service and agent wiring**
...
- [x] **Step 4: Add deterministic Compose boundary verification**
...
- [x] **Step 5: Run GREEN and configuration checks**
...
- [x] **Step 3: Grant only the existing app-owned queue operations**
...
- [x] **Step 4: Implement terminal deletion and expiry proof**
...
- [x] **Step 5: Run GREEN with real database**
...
- [x] **Step 2: Run full static and dependency gates**
...
- [x] **Step 4: Run compiled-process and container smoke tests**
...
- [x] **Step 5: Inspect the complete R8c diff**
...
- [x] **Step 8: Commit closeout and remove disposable resources**
...
### R8c closeout evidence (2026-08-26)

- Implementation range: `8a056f3..985024d`.
- Full PostgreSQL suite: `762` passed; `1` credential-gated Blockfrost live test skipped.
- Static gates: typecheck, build, compiled imports, registry `20/20`, production audit `0` vulnerabilities, Compose config, and diff check passed.
- Runtime gates: isolated extractor Docker smoke and compiled `main.js --worker` smoke passed, including safe DOCX, exact Unicode boundary TXT, deterministic terminal rejection, retry without duplicate delivery, persisted tamper rejection, and zero retained private state.
- Independent correctness review: PASS after remediation.
- Independent security review: PASS after remediation.
- R9 evaluation and R10 release work remain open in the parent plan.

## Checkpoints

### After Tasks 1–3: Extraction boundary

- [x] Supported-format protocol and exact limits pass.
- [x] Unsafe PDF/DOCX cases fail closed.
- [x] Authenticated internal service passes timeout/cancellation tests.
- [x] Public extraction regressions pass.

### After Tasks 4–7: Complete private path

- [x] Comparison requires correct private/public provenance.
- [x] Encrypted queue contains no plaintext metadata.
- [x] Telegram download is origin-locked and bounded.
- [x] No private content reaches conversation or knowledge paths.

### After Tasks 8–10: Deployable integration

- [x] Polling and webhook behave consistently.
- [x] Compose isolation and private model aliases validate.
- [x] Real PostgreSQL proves terminal deletion and one-hour expiry.

### After Task 11: R8c complete

- [x] Full suite and release gates pass.
- [x] Correctness and security reviews pass.
- [x] Only R8c is marked complete.
